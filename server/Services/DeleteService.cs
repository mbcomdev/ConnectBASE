...
namespace connectBase.Services
{
    ...
    {
        string DeleteDatasetValue(User user, string table, string index, string key);
        void DeleteAll(User user, string table, string index);
    }
    public class DeleteService : IDeleteService
    {
        ...
        public void DeleteAll(User user, string table, string index)
        {
        ...
        public string DeleteDatasetValue(User user, string table, string index, string key)
        {
