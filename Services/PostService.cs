...
namespace connectBase.Services
{
    ...
    {
        void Post(string table, Dictionary<string, object> data);

        void Post(string table, string nestedTable, Dictionary<string, object> data);
    }
    ...
    public class PostService : IPostService
    {
        ...
        /// <returns></returns>
        public void Post(string table, Dictionary<string, object> data)
        {
        ...
        public void Post(string table, string nestedTable, Dictionary<string, object> data)
        {
