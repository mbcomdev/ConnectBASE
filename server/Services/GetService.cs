...
namespace connectBase.Services
{
    ...
    {
        string GetAll(User user, string table, List<string> returnFields);
        string GetFromIndexList(User user, string table, string index, string indexList, List<string> returnFields);
        string GetIndexList(User user, string table);
        string GetFromNestedTable(User user, string table, string nestedTable, List<string> returnFields);
        string GetRange(User user, string table, string index, Dictionary<string, string> indexFields, List<string> returnFields);
    }
    public class GetService : IGetService
    {
        ...
        /// <returns></returns>
        public string GetAll(User user, string table, List<string> returnFields)
        {
            Logger.LogInformation("GetAll from table " + table);
            Application bpApp = this.COMConnection.GetUserApplication(user);
        ...
        /// <param name="returnFields"></param>
        /// <returns></returns>
        public string GetRange(User user, string table, string index, Dictionary<string, string> indexFields, List<string> returnFields)
        {
        ...
        /// <param name="returnFields"></param>
        /// <returns></returns>
        public string GetFromIndexList(User user, string table, string index, string indexList, List<string> returnFields)
        {
        ...
        /// <param name="returnFields"></param>
        /// <returns></returns>
        public string GetFromNestedTable(User user, string table, string nestedTable, List<string> returnFields)
        {
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        public string GetIndexList(User user, string table)
        {
